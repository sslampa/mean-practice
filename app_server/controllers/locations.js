...
module.exports.homelist = function(req, res) {
  res.render('locations-list', {
    ...
    sidebar: "Looking for wifi and a seat? Loc8r helps you find places to work when out and about. Perhaps with coffee, cake or a pint? Let Loc8r help you find the place you're lookin for.",
    locations: [{
      name: 'Starcups',
...
module.exports.locationInfo = function(req, res) {
  res.render('location-info', {
    ...
    reviews: [{
      ...
      reviewText: 'It was okay. Coffee was not great, but the wifi was fast.'
    }]
    }
  });
};
